...
lambda_main=0.3
lambda_rec=0.6
exp_code=${architecture}_${backbone}_BN_${loss_main}_a${lambda_main}b${lambda_rec}_ep${max_epochs}_d${proj_dim}_lr${lr_rate}_ext${pre_extracted}_AlignClip_ls2moreBS
...
# lambda_main=0.2
# lambda_rec=0.7
# exp_code=${architecture}_${backbone}_BN_${loss_main}_a${lambda_main}b${lambda_rec}_ep${max_epochs}_d${proj_dim}_lr${lr_rate}_ext${pre_extracted}_AlignClip
